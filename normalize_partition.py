...
"This code is developed by Samaneh Azadi in Prof. Pieter Abbeel's lab at UC Berkeley with the collaboration of Jeremy Maitin-Shepard."
...
def usage():
    ...
    print("           values for w_x and w_y to which the length of your input image ")
    ...
    print("<par_x>    A parameter that shows you can divide your image in x-direction in ")
    ...
    print("<par_y>    A parameter that shows you can divide your image in y-direction in ")
    ...
    print("           If your input image is too large, you should decrease the value of ")
    ...
    print(" --lm        FLOAT       The parameter that determines the relation of normalization along ")
...
#---------------------------------------------------------------
# Reading the inputs and optional parameters---------------------
...
img_path = args[0]
with h5py.File(img_path, 'r') as d:
    img = d[group_name][()]
partnum = int(args[1])
...
if step == 1 or step == 3:
    ...
    with h5py.File(f'{output_path}/parameters_final_partition{step-1}_{partnum}.h5', 'r') as g:
        x0 = g[group_name][()]
...
with h5py.File(f'{output_path}/parameters_final_partition{step}_{partnum}.h5', 'w') as f_x:
